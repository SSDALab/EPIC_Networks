...
x1 <-ndtv:::get.vertex.attribute.active(dyn,"animation.x",onset=1,terminus=1)
set.seed(123)
dyn <-compute.animation(dyn,slice.par=slice.par,verbose=FALSE)
x2 <-ndtv:::get.vertex.attribute.active(dyn,"animation.x",onset=1,terminus=1)
if (!all(x1==x2)){
...
dyn <-compute.animation(dyn,slice.par=slice.par,verbose=FALSE)
x1 <-ndtv:::get.vertex.attribute.active(dyn,"animation.x",onset=1,terminus=2)
slice.par<-list(start=0,end=2,interval=1, aggregate.dur=2,rule="any")
set.seed(123)
dyn <-compute.animation(dyn,slice.par=slice.par,verbose=FALSE)
x2 <-ndtv:::get.vertex.attribute.active(dyn,"animation.x",onset=1,terminus=2)
if (any(x1==x2)){
...
x1 <-ndtv:::get.vertex.attribute.active(stergm.sim.1,"animation.x",onset=1,terminus=2)
set.seed(123)
stergm.sim.1 <-compute.animation(stergm.sim.1,slice.par=slice.par,default.dist=100,verbose=FALSE)
x2 <-ndtv:::get.vertex.attribute.active(stergm.sim.1,"animation.x",onset=1,terminus=2)
if (any(x1==x2)){
