...
gplot.spatial(sf.net,coord,bb=bbox(sf.proj),list.vertex=list(col=col,pch=19,cex=.01),list.edges=list(col=rgb(0,0,0,.5),lwd=.3),background=sf.proj,list.background=list(border=rgb(0,0,1,.1)))
