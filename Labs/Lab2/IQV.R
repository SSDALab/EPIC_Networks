...
#	This script computes the "Index of Qualitative Variatio" for each node
...
## This is an information entropy measure (i.e. a measure of statistical dispersion in nominal distributions)
#########################################################################
